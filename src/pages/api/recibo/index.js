...
const getRecibo = async (req, res) => {
    try {
        ...
        const result = await client.query("SELECT pk_recibo, key_cuenta_pago, monto_pagado, imagen_pago, TO_CHAR(fecha_pago, 'YYYY-MM-DD') AS fecha_pago, observaciones, validacion FROM recibo;");
