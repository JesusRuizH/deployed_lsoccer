...
const getEventos = async (req, res) => {
    try {
        ...
        const result = await client.query("SELECT pk_usuario, nombre_usuario, apellidos_usuario,TO_CHAR(fecha_naci_usuario, 'YYYY-MM-DD') AS fecha_naci_usuario, correo, estado FROM usuario WHERE (fk_tipo_cuenta = 4)");
